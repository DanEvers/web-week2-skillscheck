...
// CODE HERE
let faveColors = ['black', 'white', 'blue'];
...
var me = {
    ...
    homeTown        : 'Köln',
    superPowers     : ['Invisibility', 'Ability to Fly', 'Can read minds'],
    superPowerXP    : function() {
        return Math.floor(Math.random() * 100) + 1;
    },
    profileImage    : function() {
        return url = new URL('https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg')
    }
};
//////////////////Step 3////////////////////
